    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(withDefaults())
                ...
                .authorizeRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/api/authenticate/signup","/api/authenticate/signin", "api/utils/**", "api/user/**", "api/technician/**", "api/appointment/**", "api/forum/**", "api/review/**", "api/**", "api/wishlist**").permitAll()
